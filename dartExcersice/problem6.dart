...
int? generateRandom() {
  ...
  return random.nextBool() ? 100 : null; // Randomly returns 100 or null
}
void main() {
  int status = generateRandom() ?? 0; // Assigns a default value of 0 if null
  print('Status: $status'); // Prints the status
}